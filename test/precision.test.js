...
test("validate 32-bit precisions", (t) => {
	...
	t.is(
		getFloat32Precision(
			f64(
				0b0_01101111101_0000000000000000000000000000000000000000000000000000n,
			),
		),
		Precision.Exact,
	...
	t.is(
		getFloat32Precision(
			f64(
				0b0_01101111101_1111100000000000000000000000000000000000000000000000n,
			),
		),
		Precision.Exact,
		"subnormal value with coef !=0 that can round-trip float64->float32->float64",
	...
	t.is(
		getFloat32Precision(
			f64(
				0b0_01101101010_1000000000000000000000000000000000000000000000000000n,
			),
		),
		Precision.Inexact,
	...
	t.is(
		getFloat32Precision(
			f64(
				0b0_01101111101_0000000000000000000000000000000000000000000000000111n,
			),
		),
		Precision.Inexact,
		"subnormal value with dropped non-zero bits > 0",
	...
	t.is(
		getFloat32Precision(
			f64(
				0b0_00000000000_0000000000000000000000000000000000000000000000000111n,
			),
		),
		Precision.Underflow,
		"value that will underflow",
	...
	t.is(
		getFloat32Precision(
			f64(
				0b0_01101101001_0000000000000000000000000000000000000000000000000000n,
			),
		),
		Precision.Underflow,
		"value that will underflow",
	...
	t.is(
		getFloat32Precision(
			f64(
				0b0_10001111111_0000000000000000000000000000000000000000000000000000n,
			),
		),
		Precision.Overflow,
		"value that will overflow",
